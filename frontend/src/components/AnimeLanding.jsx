...
export const Landing = () => {
    return (
        <div className="bg-white w-full flex flex-col items-center justify-start bg-gradient-to-t from-[#f0ffff] to-transparent ">
            {/*Fondo de la parte superior del landing */}
            <div className="relative w-full h-96 mb-5">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center">
                    ...
                    <h1 className="text-[#07BEB8] text-8xl mb-4 font-mono font-semibold">CrunchyTEC</h1>
                    <p className="text-white text-lg text-center font-mono">CrunchyTec es un una plataforma streaming de animes, encontraras los mejores animes del momento.</p>

                    {/*Botones de Inicio de Registro e Inicio de sesion*/}
                    <div className="absolute top-0 right-0 m-4  p-2 rounded">
                        <Link to="/register">
                            <button className="bg-[#9CEAEF] bg-opacity-75 text-black hover:text-white hover:bg-[#68D8D6] py-2 px-4 mr-2 rounded-md border-2 border-white border-opacity-45 transition-all duration-750 ease-in-out font-mono">Registrarse</button>
                        </Link>
                        <Link to="/login">
                            <button className="bg-[#9CEAEF] bg-opacity-75 text-black hover:text-white hover:bg-[#68D8D6] py-2 px-4 rounded-md border-2 border-white border-opacity-45 transition-all duration-750 ease-in-out font-mono">Iniciar Sesión</button>
                        </Link>
                    </div>
                </div>
            </div>
            ...
            {/*Contenido*/}
            <h1 className="text-5xl font-mono m-5 text-[#fdb3c5] font-bold text-center">EXPLORA </h1>
            <div className="bg-fixed bg-cover bg-center h-auto m-10 border-2 border-[#07BEB8]" style={{ backgroundImage: 'url("https://img.freepik.com/free-photo/magenta-mystical-landscape-with-nature_23-2150693917.jpg?t=st=1718524139~exp=1718527739~hmac=5cf0e58470a7e79a5384755eda2f9c4d29c033b6c51fb22a3110863a3e904a39&w=1380")' }}>
                ...
                <div className="flex items-center w-full mb-10">
                    ...
                    <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 w-full px-6">
                        ...
                        {animes.map((anime) => (
                            <div key={anime.idAnime} className="flex flex-col bg-white hover:bg-[#ffffffe0] bg-opacity-70 p-6 rounded-md border-2 border-[white] hover:shadow-2xl  shadow-lg font-mono">

                                <img className="w-full h-48 object-cover rounded border-white border-2" src={anime.img_route} alt={anime.title} />
                                <div className="mt-4 text-center">
                                    <h2 className="animate-pulse uppercase font-bold text-xl mb-2">{anime.title}</h2>
                                ...
                                <div className="flex justify-center items-center mt-5 pb-0">
                                    <button className="transition duration-500 ease-in-out bg-[#C4FFF9] hover:bg-[#9999A1]-600  hover:-translate-y-1 hover:scale-110  mt-2 py-1 px-4 rounded-full text-gray-700  border border-gray-300 hover:shadow font-semibold">
                                        <div className="text-xs">Detalles</div>
                                    </button>
                                </div>
                            </div>
                        ))}
            ...
            <footer className="w-full mt-5 bg-scroll bg-cover bg-center opacity-80 ">

                <div className="items-center mb-10 p-7 w-full flex justify-between px-60">
                    {/**Logo de Tecsup */}
                    <div className="ms-10 mt-2">
                        <img className="h-20 w-100" src="https://www.tecsup.edu.pe/themes/tecsup/logo.svg" alt="Logo" />
                    </div>
                    ...
                    <div className="flex flex-col items-center text-black">
                        ...
                        <p className="text">Diseño y Desarrollo de Software | OPEN SOURCE</p>
